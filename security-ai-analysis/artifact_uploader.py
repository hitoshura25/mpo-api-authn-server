...
class ArtifactUploader:
    ...
    def upload_artifacts(
        ...
        Args:
            ...
            test_file: Path to test_dataset.jsonl for evaluation
    ...
    def _upload_dataset(
        ...
        try:
            ...
            shutil.copy2(test_file, dataset_staging_dir / "test.jsonl")

            # Create README.md in staging with model reference
            dataset_card = self._create_dataset_card(train_file, val_file, metadata, full_repo_name, model_full_name, test_file)
...
"""
    ...
    def _create_dataset_card(self, train_file: Path, val_file: Path, metadata: Dict[str, Any], dataset_full_name: str, model_full_name: str, test_file: Path) -> str:
        """
        ...
        train_count = dataset_stats.get('train_count', 0)
        val_count = dataset_stats.get('val_count', 0)
        test_count = dataset_stats.get('test_count', 0)
...
- **Test Split**: {test_count:,} ({test_pct:.1f}%)
