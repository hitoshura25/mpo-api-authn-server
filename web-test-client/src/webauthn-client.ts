...
export class WebAuthnClient {
    ...
    constructor(options: WebAuthnClientOptions | string = {}) {
        ...
        const serverUrl = typeof options === 'string' ? options : (options.serverUrl || 'http://localhost:8080');
...
export function initializeWebAuthnClient(): void {
    ...
    (window as any).getServerUrl = function(): string {
        ...
        return serverUrlElement ? serverUrlElement.value.trim() : 'http://localhost:8080';
    };
